...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Tent heating/cooling", item: canonical },
  ],
};
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-6 px-6">
          <Breadcrumbs
            items={[
              ...
              { href: `/answers/${slug}`, label: config?.breadcrumbLabel ?? "Tent heating/cooling" },
            ]}
          />
          <p className="section-eyebrow">Quick answer</p>
          <h1 className="hero-headline text-[var(--cream)]">Can you heat or cool a tent?</h1>
