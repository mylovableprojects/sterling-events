...
const quickAnswerText =
  "It depends on your table style (round vs. rectangular), chair choice (standard vs. upgraded), linens, and delivery/setup access. As a baseline, 100 guests often means ~13 round tables (8 per table) plus 100 chairs, or a larger mix of 6-ft/8-ft rectangular tables depending on your layout. Sterling quotes the full total upfront (equipment + setup fee + any delivery/access costs) and a $500 minimum applies. Share your date, venue, and layout and we’ll send an exact itemized quote.";
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "How much does table and chair rental cost for 100 guests?",
