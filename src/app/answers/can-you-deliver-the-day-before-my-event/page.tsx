...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Day-before delivery", item: canonical },
  ],
};
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-6 px-6">
          <Breadcrumbs
            items={[
              ...
              { href: `/answers/${slug}`, label: config?.breadcrumbLabel ?? "Day-before delivery" },
            ]}
          />
          <p className="section-eyebrow">Quick answer</p>
          <h1 className="hero-headline text-[var(--cream)]">Can you deliver the day before my event?</h1>
