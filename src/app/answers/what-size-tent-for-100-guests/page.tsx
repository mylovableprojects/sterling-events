...
export const metadata: Metadata = {
  ...
  description:
    "For 100 guests, plan on a 20x40 tent minimum. Add a stage or dance floor? Size up to 30x60. Sterling Event Rentals sizes your tent to your guest count and layout in Chicago and Chicagoland.",
...
export default function AnswerPage() {
  ...
  return (
    <>
      ...
      <AnswerPageHero slug="what-size-tent-for-100-guests" title="What size tent for 100 guests?" lastCrumbLabel={config.breadcrumbLabel} />
