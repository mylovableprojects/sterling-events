...
export const metadata: Metadata = {
  ...
  description:
    "Tents over 400 sq ft or 15 ft tall require a Chicago building permit. Permits are the customer's responsibility — Sterling provides vendor documentation (COI, SIOTO cert) for your application.",
...
export default function AnswerPage() {
  ...
  return (
    <>
      ...
      <AnswerPageHero slug="do-i-need-permit-tent-chicago" title="Do I need a permit for a tent in Chicago?" lastCrumbLabel={config.breadcrumbLabel} />
      ...
      <BelowHeroQuickAnswer>
        <div className="quick-answer max-w-2xl rounded-xl border-l-4 border-[var(--gold)]/50 bg-black/35 p-4 hero-subheadline text-[var(--champagne)]/85">
          <p className="faq-answer">
            In Chicago, tents over a certain size typically require a permit
            from the Department of Buildings (private property) or the Chicago
            Park District (park venues). The permit is the customer&apos;s
            responsibility — Sterling Event Rentals does not pull permits on
            behalf of clients. Apply as early as possible; processing can take
            several weeks. See our{" "}
            <a
            ...
            for the full breakdown of when you need one and how to apply.
          </p>
        </div>
        <p className="mt-6">
          <Link
